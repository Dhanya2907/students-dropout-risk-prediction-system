...
N8N_WEBHOOK_URL = (
    "https://dhanyaraja.app.n8n.cloud/"
    "webhook-test/student-dropout"
)
...
def get_recommendations(student):
    ...
    if attendance < 50:
        ...
        recommendations.append(
            ...
            "Attend classes regularly and improve attendance immediately."
        )
        ...
        recommendations.append(
            ...
            "to maintain consistent academic participation."
        )
        ...
        recommendations.append(
            ...
            "for better academic consistency."
        )
    ...
    if study < 2:
        ...
        recommendations.append(
            ...
            "Start with at least 2–3 focused hours every day."
        )
    ...
    if internal < 40:
        ...
        recommendations.append(
            ...
            "and practice previous questions."
        )
        ...
        recommendations.append(
            ...
            "through regular revision and practice."
        )

    elif internal < 70:

        recommendations.append(
            "Try to improve internal marks further "
            "by focusing on weak subjects."
        )
    ...
    if assignment < 40:
        ...
        recommendations.append(
            "Assignment marks are very low. "
            "Complete all assignments on time "
            "and improve submission quality."
        )
    ...
    if gpa < 5:
        ...
        recommendations.append(
            ...
            "and create a weekly improvement plan."
        )

    elif gpa < 6:

        recommendations.append(
            "Focus on improving previous semester GPA "
            "through regular revision and subject-wise preparation."
        )
        ...
        recommendations.append(
            ...
            "and try to improve GPA further."
        )
    ...
    if backlogs >= 3:
        ...
        recommendations.append(
            ...
            "and give priority to failed subjects."
        )
    ...
    if not recommendations:
        ...
        recommendations.append(
            ...
            "your attendance, study routine and academic performance."
        )

        recommendations.append(
            "Keep your assignments, internal marks and GPA "
            "at the current level or improve them further."
        )
...
def send_to_n8n(
    ...
    payload = {
        ...
        "previous_semester_gpa": student["gpa"],
    ...
    terminal_log(
        f"Sending data to: {N8N_WEBHOOK_URL}"
    )
    ...
    try:
        ...
        if 200 <= response.status_code < 300:
            ...
            terminal_log(
                "Prediction successfully sent to n8n."
            )
...
def validate_student_data():
    ...
    try:
        ...
        messagebox.showerror(
            "Invalid Attendance",
            "Enter a valid attendance value."
        )
    ...
    try:
        ...
        messagebox.showerror(
            "Invalid Study Hours",
            "Enter a valid study hours value."
        )
    ...
    try:
        ...
        messagebox.showerror(
            "Invalid Backlogs",
            "Backlogs must be a whole number."
        )
...
def show_risk_students(
    ...
    for student in students:
        ...
        prediction, probabilities = ml_prediction(
            student
        )
...
def show_dashboard():
    ...
    tk.Label(
        info,
        text=(
            "Risk prediction is generated using "
            "the trained Random Forest machine learning model. "
            "Click any risk card to view students."
        ),
        font=("Arial", 11),
        bg=WHITE,
        fg=GRAY,
...
def perform_selected_prediction():
    ...
    risk, risk_color, risk_light = risk_display(
        prediction
    )
    ...
    if n8n_sent:
        ...
        terminal_log(
            "n8n workflow was not triggered."
        )
    ...
    if n8n_sent:
        ...
        n8n_text = "✓ Prediction sent to n8n successfully"
        n8n_color = GREEN

    else:

        n8n_text = "⚠ Prediction generated, but n8n was not reached"
        n8n_color = ORANGE
...
if not load_model():
    ...
    messagebox.showwarning(
        "Model Not Found",
        "dropout_risk_model.pkl was not found.\n\n"
