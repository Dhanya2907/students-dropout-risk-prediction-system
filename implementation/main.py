def get_input():
    ...
    return (attendance,study_hours,internal_marks,assignment_marks,previous_semester_gpa,backlogs)
...
def predict_risk(attendance,study_hours_score,internal_marks,assignment_marks,gpa_score,backlog_score):
    risk_score = (
        attendance * 0.20 +
