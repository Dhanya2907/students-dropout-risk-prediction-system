...
class TestCompleteSystem(unittest.TestCase):
    ...
    def test_excel_database_exists(self):
        ...
        self.assertTrue(
            check_excel_database(),
            "student_details.xlsx was not found."
        )


    def test_machine_learning_model_exists(self):
    ...
    def test_student_database_contains_data(self):
    ...
    def test_student_data_format(self):
